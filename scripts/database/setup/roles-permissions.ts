    ...
    try {
        ...
        if (roleCount === 0) {
            ...
            await sql`
                ...
                ('admin', 'Administrator', 'Verwaltung von Inhalten und Benutzern', '["users.view","users.create","users.edit","users.delete","events.view","events.create","events.edit","events.delete","events.cancel","news.view","news.create","news.edit","news.delete","gallery.view","gallery.upload","gallery.edit","gallery.delete","shared_gallery.view","shared_gallery.edit","shared_gallery.delete","portraits.view","portraits.edit","portraits.delete","settings.view","settings.edit","logs.view","wendessen.view","wendessen.manage","archive.view","archive.create","archive.edit","archive.delete"]'::jsonb),
