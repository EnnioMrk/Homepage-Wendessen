...
export const metadata: Metadata = {
  ...
  description: "Offizielle Website unseres Dorfes - Aktuelle Informationen, Veranstaltungen und mehr",
};
        ...
        <div className="flex min-h-screen flex-col">
          ...
          <header className="sticky top-0 z-50 w-full border-b border-border bg-background relative">
            <div className="container mx-auto flex items-center justify-center py-1 relative">
              ...
              <div className="absolute left-0 top-1/2 -translate-y-1/2">
                <Image
                  src="/images/Wappen_Wendessen.png"
              ...
              <div className="flex-1 flex justify-center lg:hidden">
                <span className="font-bold text-lg text-foreground">Willkommen in Wendessen</span>
              </div>
          ...
          <footer className="border-t border-border bg-background">
            <div className="container mx-auto px-4 py-6 text-center text-sm text-foreground-muted">
              © {new Date().getFullYear()} Dorfleben. Alle Rechte vorbehalten.
            </div>
          </footer>
        </div>
      </body>
