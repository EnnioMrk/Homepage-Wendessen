...
export default function GalleryImagePicker({ onSelect, onClose, canUpload = false }: GalleryImagePickerProps) {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[70] p-4">
            <div className="bg-white rounded-lg w-full max-w-4xl max-h-[80vh] flex flex-col">
                <div className="p-4 border-b flex justify-between items-center">
                    <h3 className="text-lg font-medium text-gray-900">Bild aus Galerie wählen</h3>
                ...
                <div className="flex-1 overflow-y-auto p-4">
                    {loading ? (
                        ...
                        <div className="text-center py-8 text-gray-500">Keine Bilder gefunden</div>
                    ) : (
