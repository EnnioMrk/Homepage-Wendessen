        ...
        <li>
            <NavigationMenuLink asChild>
                <a
                    ref={ref}
                    className={cn(
                        'block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-primary/20 hover:text-primary-dark focus:bg-primary/20 focus:text-primary-dark',
                        className
                    )}
                    {...props}
                >
        ...
        <NavigationMenu className="max-w-full bg-white shadow-md border-b">
            <NavigationMenuList className="flex flex-wrap justify-center p-4">
                ...
                <NavigationMenuItem>
                    ...
                    <NavigationMenuContent>
                        <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px] max-h-[80vh] overflow-y-auto">
                            {dorflebenItems.map((item) => (
                                <li key={item.title} className="row-span-3">
                                    {item.href ? (
                                        ...
                                        <div className="block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-primary/20 hover:text-primary-dark focus:bg-primary/20 focus:text-primary-dark">
                                            <div className="text-sm font-medium leading-none">
                                                {item.title}
                                            </div>
                                            {item.items && (
                                                        ...
                                                        (subItem) => (
                                                            ...
                                                            >
                                                                <Link
                                                                    ...
                                                                    className="block text-sm leading-none text-muted-foreground hover:text-primary-dark font-medium"
                                                                >
                                                                    {
                                                                        subItem.title
                                                                    }
                                                                        ...
                                                                        {subItem.items.map(
                                                                            (
                                                                                ...
                                                                                <Link
                                                                                    ...
                                                                                    className="block text-sm leading-none text-muted-foreground hover:text-primary-dark"
                                                                                >
                                                                                    {
                                                                                        subSubItem.title
                                                                                    }
