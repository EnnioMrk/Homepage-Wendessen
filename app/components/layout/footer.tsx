...
export async function Footer() {
    ...
    const copyrightText =
        settings.copyright_text || '© 2025 Ennio Marke/Ortsrat Wendessen';
    const whatsappUrl = settings.whatsapp_channel_url || '';
    const whatsappEnabled = settings.whatsapp_channel_enabled === 'true';
