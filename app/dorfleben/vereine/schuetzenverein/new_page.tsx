            ...
            <div className="container mx-auto px-4 max-w-6xl mt-8 relative z-10">
                    ...
                    <div className="grid md:grid-cols-3 gap-12 items-start">
                        <div className="md:col-span-2 space-y-6">
                            ...
                            <p className="text-lg text-slate-600 leading-relaxed">
                                ...
                                ist mehr als nur ein Name. Bei uns können
                                Kinder, Jugendliche, Frauen und Männer den
                                Schießsport ausüben – allein, zu zweit oder mit
                                der ganzen Familie.
                            </p>
                        </div>
                        ...
                        <div className="bg-slate-50 rounded-xl p-6 border border-slate-100 h-full">
                            ...
                            <div className="mt-8 pt-6 border-t border-slate-200">
                                ...
                                <p className="text-sm font-medium text-slate-900">
                                    Interessierte Bürger sind jederzeit herzlich
                                    willkommen.
                                </p>
                            </div>
                        </div>
                ...
                <div className="mb-12">
                    <div className="flex items-center mb-8">
                        <h3 className="text-2xl font-bold text-slate-900 mr-4">
                            Unsere Ausstattung
                        </h3>
                ...
                <div className="grid lg:grid-cols-12 gap-8 mb-16">
                    ...
                    <div className="lg:col-span-4 space-y-6">
                        <div className="bg-white text-slate-900 rounded-xl p-8 h-full flex flex-col relative overflow-hidden border border-slate-200 shadow-sm transition-all hover:shadow-md">
                            <div className="absolute top-0 right-0 p-8 opacity-5 text-slate-900">
                                <Target className="w-32 h-32" />
                            </div>

                            <h3 className="text-2xl font-bold mb-4 relative z-10 text-slate-900">
                                Jugendabteilung
                            </h3>
                            <p className="text-slate-600 mb-8 relative z-10 leading-relaxed">
                                Ein wichtiger Bestandteil unseres Vereins. Für
                                Jugendliche von 9-17 Jahren bieten wir neben
                                Luftgewehr und Luftpistole auch viele
                                Freizeitaktivitäten.
                            </p>
                            ...
                            <div className="mt-auto relative z-10 space-y-6">
                                <div className="bg-slate-50 p-4 rounded-lg border border-slate-100">
                                    ...
                                    <p className="text-sm text-slate-500">
                                        Schon ab 6 Jahren möglich, da völlig
                                        ohne Munition.
                                    </p>
                                </div>
                                ...
                                <div className="bg-red-50 border border-red-100 p-4 rounded-lg">
                                    <div className="flex items-start text-red-800">
                                        <Warning className="w-4 h-4 mr-2 mt-0.5 flex-shrink-0 text-red-600" />
                                        <span className="text-sm">
                                            Derzeit kann leider kein Training
                    ...
                    <div className="lg:col-span-8">
                        ...
                        <div className="grid sm:grid-cols-2 gap-4">
                            ...
                            <div className="bg-white p-6 rounded-xl border border-slate-200 hover:border-slate-300 transition-all">
                                ...
                                <p className="text-sm text-slate-500">
                                    Das Highlight des Jahres mit großer
                                    Königsproklamation.
                                </p>
                            </div>
                            ...
                            <div className="bg-white p-6 rounded-xl border border-slate-200 hover:border-slate-300 transition-all">
                                <div className="flex items-start justify-between mb-4">
                                    <h4 className="font-bold text-slate-900">
                                        Pokal- und Mannschaft
                                    </h4>
                                    <Trophy className="w-5 h-5 text-blue-600" />
                                </div>
                                <p className="text-sm text-slate-500">
                                    Wettkampf und Teamgeist stehen hier im
                                    Vordergrund.
                                </p>
                            </div>
                        ...
                        <div className="mt-6 bg-red-50 rounded-xl p-6 border border-red-100 flex flex-col md:flex-row md:items-center gap-6">
                            <div className="flex-1">
                                ...
                                <p className="text-sm text-red-800/80 mb-3">
                                    An diesen Veranstaltungen können alle Bürger
                                    unseres Dorfes teilnehmen. Highlight: Der
                                    Volkskönig und die Volkskönigin sind für ein
                                    Jahr kostenfreie Mitglieder.
                                </p>
                                <div className="inline-flex items-center text-xs font-medium text-amber-700 bg-amber-50 px-3 py-1.5 rounded-md border border-amber-200/50">
                                    ...
                                    Königinnen und Königen entstehen keine
                                    Kosten.
                                </div>
                            </div>
                        </div>
